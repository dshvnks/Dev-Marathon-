...
languageButtons.append(Button(colors["gray"], (120, 400), 80,40, "FRENCH", True, 2, 20))

errorCount = 0

# FRENCH WORDS
wordsTR = ["PSG","MANETTE","TOGO"]

# ENGLISH WORDS
wordsEN = ["NEW YORK", "WASHINGTON","LAS VEGAS", "CALIFORNIA","TEXAS","MEXICO","LONDON","MANCHESTER","BRIGHTON",
           "FLORIDA","ALABAMA","WEST VIRGINIA","ENGLAND","AMERICA","PYTHON","CHILE","ARGENTINA","AUSTRALIA",
           "MARK","BOW","ARROW","WATER BOTTLE"]

languageChoice = 1 # 1 == FRENCH, 2 == ENGLISH, DEFAULT IS FRENCH
if languageChoice == 1:
