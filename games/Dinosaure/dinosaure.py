...
pygame.display.set_caption("Dinauzaure")

Ico = pygame.image.load("asset/DinoWallpaper.png")
pygame.display.set_icon(Ico)

RUNNING = [
    pygame.image.load(os.path.join("asset/Dino", "DinoRun1.png")),
    pygame.image.load(os.path.join("asset/Dino", "DinoRun2.png")),
]
JUMPING = pygame.image.load(os.path.join("asset/Dino", "DinoJump.png"))
DUCKING = [
    pygame.image.load(os.path.join("asset/Dino", "DinoDuck1.png")),
    pygame.image.load(os.path.join("asset/Dino", "DinoDuck2.png")),
]

SMALL_CACTUS = [
    pygame.image.load(os.path.join("asset/Cactus", "SmallCactus1.png")),
    pygame.image.load(os.path.join("asset/Cactus", "SmallCactus2.png")),
    pygame.image.load(os.path.join("asset/Cactus", "SmallCactus3.png")),
]
LARGE_CACTUS = [
    pygame.image.load(os.path.join("asset/Cactus", "LargeCactus1.png")),
    pygame.image.load(os.path.join("asset/Cactus", "LargeCactus2.png")),
    pygame.image.load(os.path.join("asset/Cactus", "LargeCactus3.png")),
]

BIRD = [
    pygame.image.load(os.path.join("asset/Bird", "Bird1.png")),
    pygame.image.load(os.path.join("asset/Bird", "Bird2.png")),
]

CLOUD = pygame.image.load(os.path.join("asset/Other", "Cloud.png"))
...
def main():
    ...
    def score():
        ...
        with open("games/Dinosaure/score.txt", "r") as f:
